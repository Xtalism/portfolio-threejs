    ...
    return (
        <section className='c-space my-20' id="about">
            <div className='grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 h-full'>
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        <img src="/assets/amiga_floppy_disk.png" alt="Grid 2" className="w-full sm:h-[276px] h-fit object-contain" />
                        <div>
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container h-[400px] md:h-[500px]">
                        <img src="/assets/cartoon_mini_keyboard.png" alt="grid-3" className="w-full sm:h-[330px] h-fit object-contain" />
                        <div>
